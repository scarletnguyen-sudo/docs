...
description: "This guide helps you understand the workspace layout and where to find key modules for automation, reporting, and insights."
---
...
3. **Top bar** — Access filters, search, and workspace settings
   ...
   ![Filter5 Pn](/w-images/filter5.png)

   ![Workspacename Pn](/w-images/workspacename.png)
